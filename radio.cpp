/* initial seed of radio control.
 * not sure where it will go.
 * currently supported only when #ifdef _IS_ESP8266 or _IS_RPI
 */
...
/* define command strings, same on all supported platforms
 */
...
#endif  // either supported platform
 ...
 * can not use HW serial because Electraft wants inverted mark/space so timing
 * will not be perfect.
 *
 *
 **********************************************************************************
